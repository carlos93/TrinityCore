...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_INS_CHARACTER_MYTHIC_PLUS_RUN,
    CHAR_SEL_CHARACTER_MYTHIC_PLUS_RUN_BY_CHAR,
    ...
    CHAR_INS_ITEM_INSTANCE_KEYSTONE,
    CHAR_SEL_ITEM_INSTANCE_KEYSTONE,
    CHAR_DEL_ITEM_INSTANCE_KEYSTONE,
    CHAR_DEL_ITEM_INSTANCE_KEYSTONE_BY_OWNER,
    CHAR_UPD_GIFT_OWNER,
    CHAR_DEL_GIFT,
    ...
    CHAR_SEL_MYTHIC_PLUS_RUN_MAXID,
    CHAR_INS_MYTHIC_PLUS_RUN,
